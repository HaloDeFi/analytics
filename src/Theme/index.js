...
const theme = (darkMode, color) => ({
  ...
  haloGreen: darkMode ? '#00FF00' : 'black',
  ...
  //primary colors
  primary1: darkMode ? '#2172E5' : '#00FF00',
  ...
  // color text
  primaryText1: darkMode ? '#6da8ff' : '#00FF00',

  // secondary colors
  secondary1: darkMode ? '#2172E5' : '#00FF00',
  ...
  background: darkMode ? 'black' : `radial-gradient(50% 50% at 50% 50%, #00FF0030 0%, #fff 0%)`,
})
